...
public class VoiceInterviewController {
    ...
    public Result<SessionResponseDTO> getSession(@PathVariable Long sessionId, HttpServletRequest httpServletRequest) {
    ...
    public Result<SessionResponseDTO> resumeSession(@PathVariable Long sessionId, HttpServletRequest httpServletRequest) {
    ...
    private void applyWebSocketUrl(SessionResponseDTO session, HttpServletRequest request) {
