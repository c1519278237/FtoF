...
const VideoInterviewPage = lazy(() => import('./pages/VideoInterviewPage'));
      ...
      <Suspense fallback={<Loading />}>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="video-interview" element={<VideoInterviewPageWrapper />} />
...
function VideoInterviewPageWrapper() {
